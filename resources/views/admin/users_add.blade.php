...
<h5 class="text-dark border-bottom"><a href="{{ route('admin_users_list') }}" class="text-muted">Users List</a>/Add New User</h5>
</div>
<div class="col-12">
                    ...
                    <div class="col-12 mb-3">
                        <div class="row">
                            <div class="col-md-4 mx-auto d-flex flex-column align-items-center">
                                <img id="avatar_img_preview" src="{{ Storage::url('avatars/default_avatar.png') }}" class="img-fluid" width="150px">
